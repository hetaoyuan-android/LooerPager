        ...
        if(mInnerAdapter != null && mTitleSetListener != null) {
            ...
            for(int i = 0; i < count; i++) {
                ...
                if(mViewPager.getCurrentItem() % mInnerAdapter.getDataSize() == i) {
                   ...
                   point.setBackgroundColor(Color.parseColor("#000000"));
                }
                //设置大小
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(SizeUtils.dip2px(getContext(),10),SizeUtils.dip2px(getContext(),4));
